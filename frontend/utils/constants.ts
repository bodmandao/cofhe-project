...
export const UNDERWRITER_AUCTION_ADDRESSES: Record<number, `0x${string}`> = {
  [arbitrumSepolia.id]: (process.env.NEXT_PUBLIC_UNDERWRITER_AUCTION_ADDRESS_ARB_SEPOLIA || "0x0000000000000000000000000000000000000000") as `0x${string}`,
  [sepolia.id]:         (process.env.NEXT_PUBLIC_UNDERWRITER_AUCTION_ADDRESS_ETH_SEPOLIA  || "0x0000000000000000000000000000000000000000") as `0x${string}`,
};
